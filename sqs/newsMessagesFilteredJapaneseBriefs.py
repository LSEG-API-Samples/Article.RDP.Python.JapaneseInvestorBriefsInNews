...
#
#		Subscribes to Japanese Briefs in News  
#
...
requestFile = "./JapaneseBriefsRequestExample1.json"
...
# read file at specified location
	with open(requestFile, 'r') as reqFile:
		jsonRequest = json.load(reqFile)

	requestData = json.dumps(jsonRequest)
	...
	dResp = requests.post(RESOURCE_ENDPOINT, headers = hdrs, data = json.dumps(jsonRequest))
