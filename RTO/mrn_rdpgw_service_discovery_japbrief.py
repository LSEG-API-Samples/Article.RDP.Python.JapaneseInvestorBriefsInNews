...
# |-----------------------------------------------------------------------------
# |
# | This example helps identify Japanese Briefs in News  
# | product = NP:RINBX => Japanese Briefs
# | language = ja => in Japanese
# | subject = G:6J => relevant to United States
# |-----------------------------------------------------------------------------
"""
